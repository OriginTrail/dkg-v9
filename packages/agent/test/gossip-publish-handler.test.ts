...
describe('GossipPublishHandler', () => {
  ...
  it('rejects forged ontology policy approvals from non-owners', async () => {
    const { store, handler } = createHandler(undefined, {
      getContextGraphOwner: async (id) => id === 'ops-policy' ? 'did:dkg:agent:0x5555555555555555555555555555555555555555' : null,
    });
    ...
    const data = makePublishMessage({
      ...
      nquads: [
        ...
        '<did:dkg:policy-binding:ops-policy:incident-review:default:1> <https://dkg.network/ontology#approvedBy> <did:dkg:agent:0x6666666666666666666666666666666666666666> <did:dkg:context-graph:ontology> .',
  ...
  it('rejects ontology policy revocations that omit revokedBy', async () => {
    ...
    const data = makePublishMessage({
      ...
      nquads: [
        ...
        '<did:dkg:policy-binding:ops-policy:incident-review:default:missing-revoked-by> <https://dkg.network/ontology#approvedBy> <did:dkg:agent:0x5555555555555555555555555555555555555555> <did:dkg:context-graph:ontology> .',
  ...
  it('accepts ontology policy approvals from the current paranet owner', async () => {
    ...
    const data = makePublishMessage({
      ...
      nquads: [
        ...
        '<did:dkg:policy-binding:ops-policy:incident-review:default:1> <https://dkg.network/ontology#approvedBy> <did:dkg:agent:0x5555555555555555555555555555555555555555> <did:dkg:context-graph:ontology> .',
        '<did:dkg:policy-binding:ops-policy:incident-review:default:1> <https://dkg.network/ontology#approvedAt> "2026-03-24T00:00:00.000Z" <did:dkg:context-graph:ontology> .',
      ].join('\n'),
    });
