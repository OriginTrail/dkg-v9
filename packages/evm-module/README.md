...
- **ABI exports** — compiled contract ABIs available at `./abi/*.json` for use by `@dkg/chain`
...
This package is consumed as an ABI source by `@dkg/chain`. You don't need to interact with it directly unless you're modifying or deploying contracts.
...
```typescript
import HubAbi from '@dkg/evm-module/abi/Hub.json';
import ParanetAbi from '@dkg/evm-module/abi/Paranet.json';
```

## Internal Dependencies

None — standalone Solidity/Hardhat project. Consumed by `@dkg/chain`.
